...
const NavButtons = () => {
	return (
		<>
			<div className="flex justify-between items-center font-bold font-Roboto text-lg gap-1 px-4 py-2 text-slate-900">
				<Link
					to={"/login"}
				...
				>
					...
					<span className="ease absolute bottom-0 right-0 h-0 w-0 border-b-2 border-slate-800 transition-all duration-200 group-hover:w-full"></span>
					<span className="ease absolute bottom-0 left-0 h-0 w-0 border-l-2 border-slate-800 transition-all duration-200 group-hover:h-full"></span>
					LOGIN
				</Link>
				<Link
					to={"/register"}
